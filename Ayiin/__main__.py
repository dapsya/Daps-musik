...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! Daps Music has started successfully!\n"
    )
    try:
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("crossuoy")
            await ASS_CLI_2.join_chat("privatedap")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("crossouy")
            await ASS_CLI_3.join_chat("privatedap")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("crossouy")
            await ASS_CLI_4.join_chat("privatedap")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("crossouy")
            await ASS_CLI_5.join_chat("privatedap")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("crossouy")
            await LOG_CLIENT.join_chat("privatedap")
        except:
            pass
